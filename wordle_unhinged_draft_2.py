import random
list_of_words = ['bark','meow','disk', 'lost', 'word', 'poem', 'fact', 'girl', 'town', 'love', 'dirt', 'rant', 'news', 'bird', 'army', 'milk','lily', 'node', 'shot', 'heat', 'race', 'debt', 'fade', 'bean', 'meal', 'pour', 'fire', 'hang', 'cage', 'take', 'pack', 'wake', 'trip', 'half', 'crop', 'pace', 'rung', 'dorm', 'grow', 'tidy','plot']
index_of_word = random.randint (0, len(list_of_words))
num_chances = 4
